            ...
            <form action="{{ route('admin.manage.staff.update') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="can_create_crate_items" @if ($user->can_create_crate_items) checked @endif>
                            <label class="form-check-label" for="can_create_crate_items">Can Create Crate Items</label>
                        </div>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="can_create_bundle_items" @if ($user->can_create_bundle_items) checked @endif>
                    ...
                    <div class="col-md-3">
                        <strong>Jobs</strong>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="can_view_job_listing_responses" @if ($user->can_view_job_listing_responses) checked @endif>
                            <label class="form-check-label" for="can_view_job_listing_responses">Can View Responses</label>
                        </div>
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="can_create_job_listings" @if ($user->can_create_job_listings) checked @endif>
