...
Route::group(['as' => 'jobs.', 'prefix' => 'jobs', 'namespace' => 'Jobs'], function() {
    Route::group(['as' => 'responses.', 'prefix' => 'responses'], function() {
        Route::get('/', 'ResponsesController@index');
        Route::get('/{category}', 'ResponsesController@index')->name('index');
        Route::get('/view/{id}', 'ResponsesController@view')->name('view');
        Route::post('/update', 'ResponsesController@update')->name('update');
    });

    Route::group(['as' => 'listings.', 'prefix' => 'listings'], function() {
        Route::get('/', 'ListingsController@index');
        Route::get('/{category}', 'ListingsController@index')->name('index');
        Route::get('/view/{uid}', 'ListingsController@view')->name('view');
        Route::get('/listing/new', 'ListingsController@new')->name('new');
        Route::post('/create', 'ListingsController@create')->name('create');
        Route::get('/edit/{uid}', 'ListingsController@edit')->name('edit');
        Route::post('/edit', 'ListingsController@update')->name('update');
    });
});
